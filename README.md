...
- 😎 My skills: <br/><br/> &nbsp; [![My Skills](https://skillicons.dev/icons?i=python,react,redux,ts,nestjs,nuxtjs,vue,nodejs,nextjs,graphql,mongodb,postgres,mysql,firebase,postman,gulp,heroku,netlify,jquery,materialui,figma,js,bootstrap,jquery,html,sass,css,github)](https://skills.thijs.gg)<br/><br/>
